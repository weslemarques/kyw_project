...
public class ProjectRoleService {
    ...
    public ProjectRoleService(ProjectRoleRepository projectRoleRepository, ModelMapper mapper, ProjectRepository projectRepository, UserRepository userRepository) {
    ...
    public String getProjectRoleByProjectAndUser(UUID projectId){
        ...
        var userId = Auth.getUserAuthenticate().getId();
        System.out.println(userId);
        ProjectRole projectRole = projectRoleRepository.findProjectRoleByProject_IdAndUser_Id(projectId,userId)
                .orElseThrow(() -> new AuthorizationException("Usuário não tem papel nesse projeto"));
